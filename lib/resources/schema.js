...
const ALLOWED_EXTENSIONS = {
  download: new Set([".fxp", ".serumpreset", ".fst", ".mid", ".midi", ".zip", ".flp", ".wav"]),
...
export function validateFileBytes(bytesInput, filename, kind) {
  ...
  const signatures = {
    ...
    ".fst": () => startsWith(bytes, [0x46, 0x4c, 0x68, 0x64])
      && startsWith(bytes, [0x46, 0x4c, 0x64, 0x74], 14)
      && [0x20, 0x30, 0x40].includes(bytes.readUInt16LE(8)),
